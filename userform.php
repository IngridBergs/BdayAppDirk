<div id='userForm'>
    ...
    <form autocomplete="off" action="./includes/signup.inc.php" method="post">
        ...
        <input onfocus="$(this).val('')" type="url" name="url1" value="Vul hier de titel of naam van de muziekant in." required>
        <input onfocus="$(this).val('')" type="url" name="url2" value="Vul hier de titel of naam van de muziekant in." required><br>
        <input onfocus="$(this).val('')" type="url" name="url3" value="Vul hier de titel of naam van de muziekant in." required><br>
